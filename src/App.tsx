...
import { Sparkles, Scissors, Star, Phone, Mail, MapPin, Clock } from 'lucide-react';
  ...
  const featuredServices = [
    {
      ...
      price: '$65',
      duration: '60 min',
      image: 'https://images.unsplash.com/photo-1519014816548-bf5fe059798b?auto=format&fit=crop&w=400&h=250',
      description: 'Includes massage, scrub, and premium polish'
    },
    {
      title: 'Gel Manicure',
      price: '$45',
      duration: '45 min',
      image: 'https://images.unsplash.com/photo-1610992015732-2449b0bb0a86?auto=format&fit=crop&w=400&h=250',
    ...
    },
    {
      ...
      price: '$75',
      duration: '75 min',
      image: 'https://images.unsplash.com/photo-1604654894810-df63bc536371?auto=format&fit=crop&w=400&h=250',
      description: 'Premium acrylic extensions with design'
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-violet-50 via-pink-50 to-white">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">Premium Nail Care & Beauty</p>
              </div>
            </div>
      ...
      <main className="max-w-7xl mx-auto px-4 py-12">
        {/* Hero Section */}
        <div className="bg-white rounded-2xl shadow-xl mb-16 overflow-hidden">
          <div className="grid md:grid-cols-2 gap-8">
            <div className="p-8 md:p-12">
              <div className="inline-flex items-center gap-2 bg-violet-50 text-violet-700 px-4 py-2 rounded-full mb-6">
                <Sparkles className="w-4 h-4" />
                <span className="font-medium">Premium Nail Services</span>
              </div>
              <h2 className="text-4xl font-bold text-gray-900 mb-4">
                Experience Luxury<br />at Your Fingertips
              </h2>
              <p className="text-lg text-gray-600 mb-8">
                Book your perfect nail experience with our AI-powered scheduling system.
                Professional care tailored to your preferences.
              </p>
              <VoiceInput onTranscriptionComplete={handleTranscription} />
            </div>
            <div className="relative hidden md:block">
              <img
                src="https://images.unsplash.com/photo-1632345031435-8727f6897d53?auto=format&fit=crop&w=800&h=600"
                alt="Nail Salon"
        ...
        <section className="bg-white rounded-2xl shadow-xl p-8 md:p-12">
          <div className="text-center max-w-2xl mx-auto mb-12">
            ...
            <p className="text-gray-600">
              Choose your preferred service, stylist, and time. We'll make sure your experience is perfect.
            </p>
          </div>
          <AppointmentForm />
        </section>
        ...
        <div className="max-w-7xl mx-auto px-4 py-16">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
            <div>
              <div className="flex items-center gap-3 mb-6">
                ...
                <h3 className="text-xl font-bold">Elegant Nails</h3>
              </div>
              <p className="text-gray-400">
                Premium nail care services for those who appreciate luxury and quality.
              </p>
            </div>
            <div>
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center gap-3 text-gray-400">
                  ...
                  <span>contact@elegantnails.com</span>
                </div>
                <div className="flex items-center gap-3 text-gray-400">
          ...
          <div className="mt-12 pt-8 border-t border-gray-800">
            <p className="text-center text-gray-400">
              © {new Date().getFullYear()} Elegant Nails. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
